...
<body>
      ...
      ?>
        <form action="<?php echo base_url().'admin/login/authenticate' ;?>" name="loginform" id="loginform"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control my-2" name="username" id="username" placeholder="Nama Pengguna">
                <span></span>
            </div>
            <?php echo form_error('username'); ?>
            <div class="form-group">
                <label for="password">Kata Sandi</label>
                <input type="password" class="form-control my-2" name="password" id="password" placeholder="Kata Sandi">
                <span></span>
            </div>
    ...
    <script>
        ...
        const validate = () => {
            ...
            if(passwordVal === "") {
                setErrorMsg(password, 'kata sandi tidak boleh kosong');
            } else {
