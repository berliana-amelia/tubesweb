...
<body>
    <div class="wrapper container">
        ...
        <form action="<?php echo base_url().'singup/create_user'; ?>" method="POST" name="myForm" id="myForm"
            ...
            <div class="row">
                ...
                <?php echo (form_error('username') != "") ? 'is-invalid' : '';?>" name="username" id="userName"
                            placeholder="Masukkan Nama Pengguna" value="<?php echo set_value('username')?>">
                ...
                <?php echo (form_error('firstname') != "") ? 'is-invalid' : '';?>" name="firstname" id="firstName"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control
                <?php echo (form_error('email') != "") ? 'is-invalid' : '';?>" name="email" placeholder="Surel"
        ...
        <?php echo (form_error('address') != "") ? 'is-invalid' : '';?>"
            ...
            <p>Sudah punya akun? <a href="<?php echo base_url().'login/index';?>">Masuk Sekarang!</a></p>
        </form>
    </div>
    ...
    const validate = () => {
        ...
        if (userNameVal === "") {
            ...
            setErrorMsg(userName, 'panjang nama pengguna harus antara 5 dan 15 karakter');
        } else if (!isNaN(userNameVal)) {
            setErrorMsg(userName, 'hanya karakter yang diizinkan');
        } else {
        ...
        if (firstNameVal === "") {
            ...
            setErrorMsg(firstName, 'hanya karakter yang diizinkan');
        } else {
        ...
        //validasi surel
        if (emailVal === "") {
            setErrorMsg(email, 'surel tidak boleh kosong');
        } else if (isEmail(emailVal) === "fail") {
            setErrorMsg(email, 'masukkan surel yang valid');
        } else {
            setSuccessMsg(email);
        }
