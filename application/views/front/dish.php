<div class="container p-4">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Menu dari <?php echo $res['name']; ?></h1>
        </div>
    </div>
    <div class="container res-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                Sebuah hidangan yang indah menanti Anda dengan hidangan super musiman yang dibuat dengan cinta oleh koki kami yang luar biasa.
                </p>
            </div>
        </div>
    </div>
...
<div class="container p-4 dish-card">
    <div class="row">
        ...
        <?php } else { ?>
        <div class="jumbotron">
            <h1>Tidak ada catatan ditemukan</h1>
        </div>
        <?php } ?>
    </div>
    <hr class="my-4">
