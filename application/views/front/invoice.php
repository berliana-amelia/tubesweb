    ...
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <div class="invoice mb-3">
            <div class="row mb-3 p-3">
                <div class="col-6">
                    <h3 style="color:red"><b>RM. DJ Minang Raya</b></h3>
                </div>
                <div class="col-6">
        ...
        <footer class="text-center">
            <p class="mb-0">Terima Kasih Telah Memesan dan Memilih Kami!</p>
            <p>Kami Harap Dapat Berjumpa Kembali</p>
            <p>Untuk syarat dan ketentuan, Silakan kunjungi www.website.com</p>
        </footer>
    </div>
